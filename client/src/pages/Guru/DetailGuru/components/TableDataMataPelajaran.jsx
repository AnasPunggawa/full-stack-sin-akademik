...
function TableDataMataPelajaran({ DataMataPelajaran }) {
  return (
    <div>
...
TableDataMataPelajaran.propTypes = {
  DataMataPelajaran: PropTypes.array,
};

export default TableDataMataPelajaran;
