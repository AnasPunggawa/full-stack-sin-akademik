...
const ComponentToPrint = forwardRef(function ComponentToPrint({ Data }, ref) {
  ...
  return (
    <div className="p-4 flex justify-start min-[900px]:justify-center overflow-x-auto">
      <div
        ref={ref}
        className="bg-white text-black font-sans page-print py-8 px-12 min-w-[21cm] min-h-[29.7cm] uppercase"
      >
        <PageHeader />
